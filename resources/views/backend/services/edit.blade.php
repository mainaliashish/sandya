...
@include('backend.partials._content-header', ['header_title' => 'Update Service'])
<!-- Main content -->
<section class="content">
    ...
    <div class="card">
        ...
        <div class="col-12 col-md-12 col-sm-12 center">
            {!! Form::model($service, ['method'=>'PATCH', 'route' => ['backend.services.update', $service], 'files'=>true]) !!}
            @include('backend.services._form', ['button_text' => 'Save Changes'])
            {!! Form::close() !!}
        </div>
    </div>
    </div>
